    ...
    public void run(){
       ...
       byte [] bytearray = new byte [filesize]; 
        try{
           ...
           if(bytesRead!=-1){ 
                FileOutputStream fos = new FileOutputStream("C:\\Users\\JOSEGREGORIO\\Desktop\\descarga"+Integer.toString(p)+".rar");
            ...
            ss.close(); 
               ...
               Object obj = var.readObject();
                ...
                System.out.println("el peso del libro a descargar :"+data.getSize());
